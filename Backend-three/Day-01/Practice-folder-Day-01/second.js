...
//     console.log(`This is my 2nd server to run `)
// })

// now I want to create a api call kaise kar gha 
// now check this mthod to create a api call ok,
const gitHub = [
{
"login": "mojombo",
"id": 1,
...
// pahle tu gitub ka jo array data tha use phale coverted kiya number format mai then api call kiya hai 

// github variable 100 data user information hai 
const server = http.createServer((request,response)=>{

    // response.end("Hello Raju bhaiya ")
    // https:localhost:3000/100 tha github data user hai 
    // request.url = 15
    ...
    // dataNumber = 100 Number format mai ha
    let number = Number(DataNumber); // dataNumber ko string to number mai convert kar diya hai 
    const arr = [];
